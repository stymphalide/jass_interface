...
var _user$project$Game_Model$Game = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {gameType: a, round: b, turn: c, players: d, group: e, activePlayer: f, onTurnPlayer: g, cardsPlayer: h, table: i};
	});
var _user$project$Game_Model$Card = F2(
	function (a, b) {
		return {color: a, number: b};
	});
var _user$project$Game_Model$Group = F3(
	function (a, b, c) {
		return {points: a, players: b, wonCards: c};
	});
var _user$project$Game_Model$Table = F4(
	function (a, b, c, d) {
		return {pos1: a, pos2: b, pos3: c, pos4: d};
	});

var _user$project$Models$initialModel = function (route) {
	return {route: route, game: _elm_lang$core$Maybe$Nothing};
};
var _user$project$Models$Model = F2(
	function (a, b) {
		return {route: a, game: b};
	});
var _user$project$Models$NotFoundRoute = {ctor: 'NotFoundRoute'};
var _user$project$Models$Play = function (a) {
	return {ctor: 'Play', _0: a};
};
var _user$project$Models$Watch = function (a) {
	return {ctor: 'Watch', _0: a};
};
var _user$project$Models$Init = {ctor: 'Init'};

var _user$project$Routing$gamePath = function (path) {
	return A2(
...
var _user$project$Routing$matchers = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _user$project$Models$Init, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
				...
				A2(
					...
					_evancz$url_parser$UrlParser$s('play'),
					_evancz$url_parser$UrlParser$string)),
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_user$project$Models$Watch,
					A2(
						_evancz$url_parser$UrlParser_ops['</>'],
						_evancz$url_parser$UrlParser$s('watch'),
						_evancz$url_parser$UrlParser$string)),
				_1: {ctor: '[]'}
			}
		}
...
var _user$project$Routing$serverUrl = 'ws://localhost:5000';

var _user$project$Msgs$Send = {ctor: 'Send'};
var _user$project$Msgs$GameUpdate = function (a) {
...
var _user$project$Decoders$cardDecoder = A3(
	...
	A3(
		...
		'color',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Game_Model$Card)));
var _user$project$Decoders$tableDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'pos4',
	_elm_lang$core$Json_Decode$maybe(_user$project$Decoders$cardDecoder),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'pos3',
		_elm_lang$core$Json_Decode$maybe(_user$project$Decoders$cardDecoder),
		A3(
			...
			A3(
				...
				'pos1',
				_elm_lang$core$Json_Decode$maybe(_user$project$Decoders$cardDecoder),
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Game_Model$Table)))));
var _user$project$Decoders$historyDecoder = _elm_lang$core$Json_Decode$maybe(
	_elm_lang$core$Json_Decode$list(
		_elm_lang$core$Json_Decode$list(_user$project$Decoders$cardDecoder)));
var _user$project$Decoders$playerDecoder = _elm_lang$core$Json_Decode$string;
var _user$project$Decoders$groupDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'wonCards',
	_user$project$Decoders$historyDecoder,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'players',
		_elm_lang$core$Json_Decode$list(_user$project$Decoders$playerDecoder),
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'points',
			_elm_lang$core$Json_Decode$int,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Game_Model$Group))));
var _user$project$Decoders$gameDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'cardsTable',
	_user$project$Decoders$tableDecoder,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'cardsPlayer',
		...
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'onTurnPlayer',
			_user$project$Decoders$playerDecoder,
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'activePlayer',
				_user$project$Decoders$playerDecoder,
						...
						A3(
							...
							A3(
								...
								A3(
									...
									'type',
									_elm_lang$core$Json_Decode$string,
									_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Game_Model$Game))))))))));

var _user$project$Commands$fetchGame = A2(_elm_lang$websocket$WebSocket$send, _user$project$Routing$serverUrl, 'fetchGame');
...
var _user$project$Game_Update$decodeGame = function (gameString) {
	var _p0 = A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Decoders$gameDecoder, gameString);
	if (_p0.ctor === 'Ok') {
		return _elm_lang$core$Maybe$Just(_p0._0);
	} else {
		return _elm_lang$core$Maybe$Nothing;
...
var _user$project$Game_Update$updateGame = function (gameString) {
	return _user$project$Game_Update$decodeGame(gameString);
};

var _user$project$Game_View$init = A2(
...
var _user$project$Game_View$imgSourcePath = '../../img/';
var _user$project$Game_View$viewGameType = function (gameType) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('Trumpf: '),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$img,
					{
						...
						_0: _elm_lang$html$Html_Attributes$src(
							A2(
								_elm_lang$core$Basics_ops['++'],
								_user$project$Game_View$imgSourcePath,
								A2(
									_elm_lang$core$Basics_ops['++'],
									_user$project$Game_Card$colorTranslate(gameType),
									'_icon.png'))),
						_1: {ctor: '[]'}
					},
					{ctor: '[]'}),
...
var _user$project$Game_View$getImagePath = F2(
	function (color, number) {
		return A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				_user$project$Game_Card$colorTranslate(color),
				A2(
					_elm_lang$core$Basics_ops['++'],
					'_',
					A2(
						_elm_lang$core$Basics_ops['++'],
						_user$project$Game_Card$numberTranslate(number),
						'.png'))));
	});
var _user$project$Game_View$viewPlayerCard = function (card) {
	return A2(
		_elm_lang$html$Html$img,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$src(
				A2(_user$project$Game_View$getImagePath, card.color, card.number)),
			_1: {ctor: '[]'}
		},
		{ctor: '[]'});
};
var _user$project$Game_View$viewPlayerCards = function (cards) {
	var _p0 = cards;
	if (_p0.ctor === 'Nothing') {
		return {
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('No Cards received'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		};
	} else {
		return A2(_elm_lang$core$List$map, _user$project$Game_View$viewPlayerCard, _p0._0);
	}
};
var _user$project$Game_View$viewPlayer = F3(
	function (activePlayer, onTurnPlayer, player) {
		return _elm_lang$core$Native_Utils.eq(player, activePlayer) ? (_elm_lang$core$Native_Utils.eq(player, onTurnPlayer) ? A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
				ctor: '::',
				...
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$img,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$src(
								A2(_elm_lang$core$Basics_ops['++'], _user$project$Game_View$imgSourcePath, 'playerActiveOnTurn_icon.png')),
							_1: {ctor: '[]'}
						},
						{ctor: '[]'}),
					_1: {ctor: '[]'}
				...
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$img,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$src(
								A2(_elm_lang$core$Basics_ops['++'], _user$project$Game_View$imgSourcePath, 'playerActive_icon.png')),
							_1: {ctor: '[]'}
						},
						{ctor: '[]'}),
					_1: {ctor: '[]'}
				}
			})) : (_elm_lang$core$Native_Utils.eq(player, onTurnPlayer) ? A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
				ctor: '::',
				...
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$img,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$src(
								A2(_elm_lang$core$Basics_ops['++'], _user$project$Game_View$imgSourcePath, 'playerOnTurn_icon.png')),
							_1: {ctor: '[]'}
						},
						{ctor: '[]'}),
					_1: {ctor: '[]'}
				...
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$img,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$src(
								A2(_elm_lang$core$Basics_ops['++'], _user$project$Game_View$imgSourcePath, 'player_icon.png')),
							_1: {ctor: '[]'}
						},
						{ctor: '[]'}),
					_1: {ctor: '[]'}
...
var _user$project$Game_View$viewPlayers = F3(
	function (activePlayer, onTurnPlayer, players) {
		return A2(
			_elm_lang$core$List$map,
			A2(_user$project$Game_View$viewPlayer, activePlayer, onTurnPlayer),
			players);
	});
var _user$project$Game_View$viewGame = function (game) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$Game_View$viewGameType(game.gameType),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
						...
						{ctor: '[]'},
						{
							...
							_0: _elm_lang$html$Html$text(
								A2(
									_elm_lang$core$Basics_ops['++'],
									'Round #',
									_elm_lang$core$Basics$toString(game.round + 1))),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$div,
							{ctor: '[]'},
							_user$project$Game_View$viewPlayerCards(game.cardsPlayer)),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$div,
								{ctor: '[]'},
								A3(_user$project$Game_View$viewPlayers, game.activePlayer, game.onTurnPlayer, game.players)),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Game_View$page = function (game) {
	var _p1 = game;
	if (_p1.ctor === 'Nothing') {
		return _user$project$Game_View$init;
	} else {
		return _user$project$Game_View$viewGame(_p1._0);
	}
};
var _user$project$Game_View$view = function (game) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$Game_View$page(game),
			_1: {ctor: '[]'}
		});
};
...
var _user$project$Updates$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'GameUpdate':
				var newGame = _user$project$Game_Update$updateGame(_p0._0);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			default:
				return {ctor: '_Tuple2', _0: model, _1: _user$project$Commands$fetchGame};
		}
	});
...
var _user$project$Subscriptions$subscriptions = function (model) {
	return A2(_elm_lang$websocket$WebSocket$listen, _user$project$Routing$serverUrl, _user$project$Msgs$GameUpdate);
};

var _user$project$Main$init = function (location) {
	var cRoute = _user$project$Routing$parseLocation(location);
	return {
		ctor: '_Tuple2',
		_0: _user$project$Models$initialModel(cRoute),
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
var _user$project$Main$main = A2(
	...
	{init: _user$project$Main$init, view: _user$project$View$view, update: _user$project$Updates$update, subscriptions: _user$project$Subscriptions$subscriptions})();
